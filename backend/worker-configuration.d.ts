/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 623dad1e3a7325cc86f14d26b1b74894)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		STUDY_MATERIAL_WORKFLOW: Workflow<Parameters<import("./src/index").StudyMaterialWorkflow['run']>[0]['payload']>;
	}
}
